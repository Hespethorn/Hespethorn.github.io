...
<svg viewBox="0 0 680 230" xmlns="http://www.w3.org/2000/svg">
  ...
  <line x1="80" y1="190" x2="640" y2="190" stroke="#9ca3af"/>
  <g font-family="sans-serif" font-size="11" text-anchor="middle">
    <rect x="95"  y="95"  width="80" height="95"  fill="#d1d5db"/><text x="135" y="85"  fill="#374151">831.8</text><text x="135" y="208" fill="#6b7280">none</text>
    <rect x="225" y="58"  width="80" height="132" fill="#22c55e"/><text x="265" y="48"  fill="#15803d">924.2</text><text x="265" y="208" fill="#6b7280">mutex</text>
    <rect x="355" y="6"   width="80" height="184" fill="#22c55e"/><text x="395" y="-4" fill="#15803d">1160</text><text x="395" y="208" fill="#6b7280">spin</text>
    <rect x="485" y="38"  width="80" height="152" fill="#22c55e"/><text x="525" y="28"  fill="#15803d">1005</text><text x="525" y="208" fill="#6b7280">atomic</text>
  </g>
  <text x="135" y="150" font-size="11" font-family="sans-serif" fill="#374151" text-anchor="middle">挡掉=0</text>
  <text x="265" y="120" font-size="11" font-family="sans-serif" fill="#14532d" text-anchor="middle">挡掉1500</text>
  <text x="395" y="100" font-size="11" font-family="sans-serif" fill="#14532d" text-anchor="middle">挡掉1500</text>
  <text x="525" y="115" font-size="11" font-family="sans-serif" fill="#14532d" text-anchor="middle">挡掉1501</text>
  <text x="340" y="224" font-size="10" font-family="sans-serif" fill="#6b7280" text-anchor="middle">开了闸门后，1500 个重复请求被挡在 DB 前，QPS 反而更高（无效请求不再占行锁）</text>
</svg>
</div>
